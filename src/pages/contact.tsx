...
export default function Contact() {
  return (
    <div className={inter2.className}>
      <Nav />
      <div className=" min-h-max px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-100">
        <div className="max-w-2xl lg:max-w-5xl mx-auto">
          ...
          <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
            {/* Card */}
            <div className="flex flex-col border shadow-md rounded-xl p-4 bg-white sm:p-6 lg:p-8 ">
