...
import jsonProjectData from "@/data/project-data.json"
...
export default function Project() {
  ...
  useEffect(() => {
    if (router.isReady) {
      ...
      const getData = jsonProjectData.find((item) => item.projectId === parseInt(detail))
        ...
        <div className="max-w-2xl">
          ...
          <div className="space-y-5 md:space-y-8">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-bold md:text-3xl ">{projectData?.project_name}</h2>
              <p className="text-lg text-gray-800 ">{projectData?.description}</p>
              <p className="text-lg text-gray-800 ">{projectData?.services_provided}</p>
            </div>
